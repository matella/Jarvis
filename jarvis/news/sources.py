...
SOURCES: list[NewsSource] = [
    ...
    # NB: Belga (the Belgian press agency) has no public RSS — it's a paid wire. Its dispatches
    # already reach us indirectly via RTBF/Le Soir/La Libre, which republish Belga content.
]
